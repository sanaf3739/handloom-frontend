  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          This website is operated by Ibrahim Rugs. Throughout the site, the terms "we",
          "us" and "our" refer to Ibrahim Rugs. Ibrahim Rugs offers this website,
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">SECTION 5 - PRODUCTS OR SERVICES</h2>
        <p className="mb-4">
          ...
          to return or exchange only according to our Refund Policy:{" "}
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          Any use by you of the optional tools offered through the site is entirely at
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">SECTION 12 - PROHIBITED USES</h2>
        <p className="mb-4">
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          In no case shall Ibrahim Rugs, our directors, officers, employees, affiliates,
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">SECTION 14 - INDEMNIFICATION</h2>
        <p className="mb-4">
          You agree to indemnify, defend and hold harmless Ibrahim Rugs and our parent,
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">SECTION 15 - SEVERABILITY</h2>
        <p className="mb-4">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">SECTION 16 - TERMINATION</h2>
        <p className="mb-4">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">SECTION 17 - ENTIRE AGREEMENT</h2>
        <p className="mb-4">
        ...
        <p className="mb-4">
          ...
          understanding between you and us and governs your use of the Service,
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">SECTION 18 - GOVERNING LAW</h2>
        <p className="mb-4">
      ...
      <footer className="mt-12 pt-8 border-t border-gray-300 text-center">
        <div className="mb-4">
          <strong>Ibrahim Rugs</strong>
          <br />
          Address: Mirzapur, Uttar Pradesh, India
          <br />
          Email: imtiazali661986@gmail.com
          <br />
          Website: www.ibrahimrugs.com
        </div>
