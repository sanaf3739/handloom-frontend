  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <p className="text-sm text-gray-600 mb-8 text-center">
        <strong>Last updated:</strong> May 02, 2025
      </p>
      
      <div className="prose prose-lg">
        <p>
          This Privacy Policy describes how Ibrahim Rugs (the "Site", "we", "us", or "our") collects, uses, and discloses your personal information when you visit, use our services, or make a purchase from our website (the "Site") or otherwise communicate with us (collectively, the "Services"). For purposes of this Privacy Policy, "you" and "your" means you as the user of the Services, whether you are a customer, website visitor, or another individual whose information we have collected pursuant to this Privacy Policy.
        </p>
        ...
        <p>
          To provide the Services, we collect and have collected over the past 12 months personal information about you from a variety of sources, as set out below. The information that we collect and uses varies depending on how you interact with us.
        </p>
        ...
        <h3 className="text-xl font-semibold mt-6 mb-3">Information We Collect Directly from You</h3>
        ...
        <h3 className="text-xl font-semibold mt-6 mb-3">Information We Collect through Cookies</h3>
        ...
        <h3 className="text-xl font-semibold mt-6 mb-3">Information We Obtain from Third Parties</h3>
        ...
        <ul className="list-disc pl-6 mb-4">
          <li>Companies who support our Site and Services, such as our e-commerce platform provider.</li>
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4">How We Disclose Personal Information</h2>
          ...
          <table className="min-w-full border border-gray-300">
            <thead>
              <tr className="bg-gray-100">
                <th className="py-2 px-4 border-b border-r border-gray-300 text-left">Category</th>
                <th className="py-2 px-4 border-b border-gray-300 text-left">Categories of Recipients</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td className="py-2 px-4 border-b border-r border-gray-300">Identifiers such as basic contact details and certain order and account information</td>
                <td className="py-2 px-4 border-b border-gray-300">Vendors and third parties who perform services on our behalf (such as Internet service providers, payment processors, fulfillment partners, customer support partners and data analytics providers)</td>
              </tr>
              <tr>
                <td className="py-2 px-4 border-b border-r border-gray-300">Commercial information such as order information, shopping information and customer support information</td>
                <td className="py-2 px-4 border-b border-gray-300">Business and marketing partners</td>
              </tr>
              <tr>
                <td className="py-2 px-4 border-b border-r border-gray-300">Internet or other similar network activity, such as Usage Data</td>
                <td className="py-2 px-4 border-b border-gray-300">Affiliates</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4">Third Party Websites and Links</h2>
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4">Security and Retention of Your Information</h2>
        ...
        <p>
          Please note that we may transfer, store and process your personal information outside the country you live in, including India and other countries. Your personal information is also processed by staff and third party service providers and partners in these countries.
        </p>
        ...
        <p>
          Should you have any questions about our privacy practices or this Privacy Policy, or if you would like to exercise any of the rights available to you, please call <a href="tel:+918545976660" className="text-blue-600 hover:underline">+91 8545976660</a> or email us at <a href="mailto:imtiazali661986@gmail.com" className="text-blue-600 hover:underline">imtiazali661986@gmail.com</a> or contact us at Ibrahim Rugs, Mirzapur, Uttar Pradesh, India.
        </p>
      </div>
    </div>
  );
